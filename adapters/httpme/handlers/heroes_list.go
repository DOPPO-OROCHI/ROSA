	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		for _, g := range owned {
			...
			out = append(out, dto.OwnedHeroDTO{
				...
				Ability: dto.HeroAbilityDTO{
					Name:         t.Ability.Name,
					Code:         t.Ability.Code,
					Description:  t.Ability.Description,
					Kind:         t.Ability.Kind,
					Target:       t.Ability.Target,
					CoolDown:     t.Ability.CoolDown,
					ManaCost:     t.Ability.ManaCost,
					Power:        t.Ability.Power,
					Duration:     t.Ability.Duration,
					ExtraValue:   t.Ability.ExtraValue,
					ApplyCount:   t.Ability.ApplyCount,
					BuffEffect:   t.Ability.BuffEffect,
					DebuffEffect: t.Ability.DebuffEffect,
					IgnoreTank:   t.Ability.IgnoreTank,
				},
